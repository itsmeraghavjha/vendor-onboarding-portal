...
# 1. Append the missing MasterData model to app/models.py
models_path = os.path.join('app', 'models.py')
with open(models_path, 'r', encoding='utf-8') as f:
    content = f.read()

if "class MasterData" not in content:
    print("Adding MasterData model to app/models.py...")
...
# 2. Overwrite app/blueprints/admin.py with the fixed version
admin_path = os.path.join('app', 'blueprints', 'admin.py')
print("Updating app/blueprints/admin.py with Master Data logic...")

new_admin_code = """from flask import Blueprint, render_template, request, redirect, url_for
...
print("Done! Master Data logic added.")